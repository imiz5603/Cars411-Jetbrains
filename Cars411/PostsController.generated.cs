...
namespace Cars411.Controllers
{
    public partial class PostsController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Posts/Create.cshtml";
            public readonly string Edit = "~/Views/Posts/Edit.cshtml";
            public readonly string Index = "~/Views/Posts/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PostsController : Cars411.Controllers.PostsController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Cars411.Models.tblPost post, System.Web.HttpPostedFileBase Image);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Cars411.Models.tblPost post, System.Web.HttpPostedFileBase Image)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ...
            CreateOverride(callInfo, post, Image);
            return callInfo;
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Cars411.Models.tblPost post, System.Web.HttpPostedFileBase Image);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Cars411.Models.tblPost post, System.Web.HttpPostedFileBase Image)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "post", post);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "Image", Image);
            EditOverride(callInfo, post, Image);
            return callInfo;
        }
